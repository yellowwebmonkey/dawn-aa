...
jQuery(function() {
  ...
  if (mode == 'dev') {
      ...
      if (flag) {
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1612810085911');
            var $module = jQuery('#m-1612810085911').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1612810085985');
            var $module = jQuery('#m-1612810085985').children('.module');
